...
function setup() {
  ...
  sid = new Monster(color(59, 275, 64), color(59, 220, 64), color(181, 35, 203), 800);
  sally = new Monster(color(195, 70, 209), color(225, 84, 250), color(0),400);
}
...
function Monster(bdclr, bdclr2, c, wt) { // pass any parameters we want to pass upon object creation
  ...
  this.display = function(locX, locY ) {
    //w = wt;
    var x = locX;
    var y = locY;
    // body
